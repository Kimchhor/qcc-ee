...
bool Block::insertUsedRegisters(int physicalRegister) {
  return insert2set(physicalRegister, usedRegisters);
};
...
void Block::setInstructions(NodeGates nodeGates) {
  ...
  auto registerInfo = QODG.getScanIntervalRegLoc(NUMBER_OF_REGISTER, TEMP_QR, ANCILLA_QR);
