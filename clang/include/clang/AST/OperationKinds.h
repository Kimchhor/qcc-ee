...
// QCL QCC - gate : determine kind of quantum operator
/** It will be used to determine kind of quantum operator */
enum QuantumOperatorKind {
#define QUANTUM_OPERATION(Name) QO_##Name,
#include "clang/AST/OperationKinds.def"
};
