...
public:
  ...
  // QCL QCC - gate
  void VisitQuantumSingleQubitGate(const QuantumOperator *QO);
  void VisitQuantumMultiQubitGate(const QuantumOperator *QO);
  void VisitQuantumMeasureGate(const QuantumOperator *QO);
