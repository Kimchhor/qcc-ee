...
protected:
  ...
  // QCL QCC - gate : define expression bitfields
  //===--- QCC (Quantum) Expression bitfields ---===//

  class QuantumOperatorBitfields {
    friend class QuantumOperator;
  ...
  union {
    ...
    // QCL QCC - gate
    // Quantum Extension
    QuantumOperatorBitfields QuantumOperatorBits;
