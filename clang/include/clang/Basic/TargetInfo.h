...
protected:
  ...
  // QCL QCC - type
  unsigned char QbitWidth, QbitAlign;
  unsigned char CbitWidth, CbitAlign;
  unsigned char AbitWidth, AbitAlign;
...
public:
  ...
  // QCL QCC - type : width and align
  /// \brief Return QCC Qbit type width and align.
  unsigned getQbitWidth() const { return 32; }
  unsigned getQbitAlign() const { return 32; }

  /// \brief Return QCC Abit type width and align.
  unsigned getAbitWidth() const { return 1; }
  unsigned getAbitAlign() const { return 1; } 

  /// \brief Return QCC Cbit type width and align.
