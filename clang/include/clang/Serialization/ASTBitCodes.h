...
enum PredefinedTypeIDs {
  ...
  // QCL QCC - type
  /// \brief The 'qbit' type for QCC
  PREDEF_TYPE_QBIT_ID = 74,
  
  /// \brief The 'cbit' type for QCC
  PREDEF_TYPE_CBIT_ID = 75,

  /// \brief the 'abit' type for QCC
  PREDEF_TYPE_ABIT_ID = 76,
