...
public:
  ...
  // QCL QCC - gate : semantic analysis for Quantum operators
  /** Semantic analysis for Quantum operators  */                        
  ExprResult BuildQuantumOp(Scope *S, SourceLocation OpLoc,
                          QuantumOperatorKind Opc, Expr *InputExpr);

  ExprResult BuildQuantumOp(Scope *S, SourceLocation OpLoc,
                          QuantumOperatorKind Opc, Expr *FInputExpr, Expr *SInputExpr);

  ExprResult BuildQuantumOp(Scope *S, SourceLocation OpLoc,
                          QuantumOperatorKind Opc, Expr *FInputExpr, Expr *SInputExpr, Expr *TInputExpr);
  ...
  ExprResult ActOnQuantumOp(Scope *S, SourceLocation OpLoc,
