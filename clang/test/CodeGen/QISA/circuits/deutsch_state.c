...
// Test QCC specific deutsch_state statement.
...
void kernel_deutsch() {
    ...
    // CHECK: %arrayidx4 = getelementptr inbounds [2 x q1], [2 x q1]* %q, i64 0, i64 1
    ...
    // CHECK: %arrayidx7 = getelementptr inbounds [2 x q1], [2 x q1]* %q, i64 0, i64 0
    // CHECK: %7 = h q1 %6
    ...
    // CHECK: %arrayidx15 = getelementptr inbounds [2 x q1], [2 x q1]* %q, i64 0, i64 0
    // CHECK: %15 = h q1 %14
    ...
    // CHECK: %arrayidx17 = getelementptr inbounds [2 x i32], [2 x i32]* %c, i64 0, i64 0
    ...
    // CHECK: %19 = measure q1 %18
    // CHECK: %arrayidx19 = getelementptr inbounds [2 x i32], [2 x i32]* %c, i64 0, i64 1
    // CHECK: store i32 %19, i32* %arrayidx19, align 4
