...
LValue CodeGenFunction::EmitLValue(const Expr *E) {
  ...
  case Expr::UnaryOperatorClass:
    ...
    // QCL QCC - gate
  case Expr::QuantumOperatorClass:
    return EmitQuantumOpLValue(cast<QuantumOperator>(E));
...
// QCL QCC - gate : TODO - emit operation LValue
LValue CodeGenFunction::EmitQuantumOpLValue(const QuantumOperator *E) {
  // __extension__ doesn't affect lvalue-ness.
  // if (E->getOpcode() == UO_Extension)
  //   return EmitLValue(E->getSubExpr());

  QualType ExprTy = getContext().getCanonicalType(E->getSubExprVal()->getType());
  ...
  // QCC: Deprecated
  // switch (E->getOpcode()) {
  // default: llvm_unreachable("Unknown quantum operator lvalue!");
  // case QO_InitX:
  // case QO_InitZ:
  // case QO_Z:
  // case QO_Y:
