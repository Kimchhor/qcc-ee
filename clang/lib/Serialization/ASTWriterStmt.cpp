...
// QCL QCC - gate : add serialization support for writing
/** Add serialization support for writing*/ 
void ASTStmtWriter::VisitQuantumOperator(QuantumOperator *E){
  VisitExpr(E);
  ...
  Record.AddStmt(E->getSubExprVal());
  Record.AddSourceLocation(E->getOperatorLoc());
  Code = serialization::EXPR_QUANTUM_OPERATOR;
}
