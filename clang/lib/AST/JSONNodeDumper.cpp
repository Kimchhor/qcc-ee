...
void JSONNodeDumper::VisitQuantumSingleQubitGate(const QuantumOperator *QO) {
  JOS.attribute("opcode", QuantumOperator::getOpcodeStr(QO->getOpcode()));
}

void JSONNodeDumper::VisitQuantumMultiQubitGate(const QuantumOperator *QO) {
  JOS.attribute("opcode", QuantumOperator::getOpcodeStr(QO->getOpcode()));
}

void JSONNodeDumper::VisitQuantumMeasureGate(const QuantumOperator *QO) {
  JOS.attribute("opcode", QuantumOperator::getOpcodeStr(QO->getOpcode()));
}
