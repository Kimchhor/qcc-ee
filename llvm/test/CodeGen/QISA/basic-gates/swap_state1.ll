; Test Swap-State1 instructions.
;
; RUN: llc < %s -march=qisa | FileCheck %s


define dso_local void @kernel_swap_1() #0 {
entry:
  ; CHECK: QMOV	QR0, 0x0
	; CHECK: INIT_Z	QR0
	; CHECK: QMOV	QR1, 0x4
  ...
  %9 = measure q1 %8
  %arrayidx9 = getelementptr inbounds [2 x i32], [2 x i32]* %c, i64 0, i64 0
  store i32 %9, i32* %arrayidx9, align 4
  %arrayidx10 = getelementptr inbounds [2 x q1], [2 x q1]* %q, i64 0, i64 1
  %10 = load q1, q1* %arrayidx10, align 4
  %11 = measure q1 %10
  %arrayidx11 = getelementptr inbounds [2 x i32], [2 x i32]* %c, i64 0, i64 1
