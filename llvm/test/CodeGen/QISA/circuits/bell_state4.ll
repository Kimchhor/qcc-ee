; Test Bell-State4 instructions.
;
; RUN: llc < %s -march=qisa | FileCheck %s


define dso_local void @kernel_bell_4() #0 {
entry:
  ; CHECK: QMOV	QR0, 0x0
	; CHECK: INIT_Z	QR0
	; CHECK: QMOV	QR1, 0x4
  ...
  %arrayidx9 = getelementptr inbounds [2 x q1], [2 x q1]* %q, i64 0, i64 0
  %9 = h q1 %8
  ...
  %15 = measure q1 %14
  %arrayidx15 = getelementptr inbounds [2 x i32], [2 x i32]* %c, i64 0, i64 0
  store i32 %15, i32* %arrayidx15, align 4
  %arrayidx16 = getelementptr inbounds [2 x q1], [2 x q1]* %q, i64 0, i64 1
  %16 = load q1, q1* %arrayidx16, align 4
  %17 = measure q1 %16
  %arrayidx17 = getelementptr inbounds [2 x i32], [2 x i32]* %c, i64 0, i64 1
