...
enum TypeCodes {
  ...
  TYPE_CODE_QUBIT = 25 // QIR HPCL: Qubit Type
};
...
enum FunctionCodes {
  ...
  FUNC_CODE_INST_XGATE = 59, // Gate [opty]
  FUNC_CODE_INST_YGATE = 60,
  FUNC_CODE_INST_ZGATE = 61,
  FUNC_CODE_INST_HGATE = 62,
  FUNC_CODE_INST_IGATE = 63,
  FUNC_CODE_INST_SGATE = 64,
  FUNC_CODE_INST_SDAGGATE = 65,
  FUNC_CODE_INST_TGATE = 66,
  FUNC_CODE_INST_TDAGGATE = 67,
  FUNC_CODE_INST_MEASXGATE = 73,
  FUNC_CODE_INST_MEASYGATE = 74,
  FUNC_CODE_INST_MEASZGATE = 75,

  FUNC_CODE_INST_SWAPGATE = 76,
  FUNC_CODE_INST_INITXGATE = 77, 
  FUNC_CODE_INST_INITZGATE = 78,
  
  FUNC_CODE_INST_CTRLGATE = 79,

  FUNC_CODE_INST_PGATE = 80,
  FUNC_CODE_INST_UGATE = 81,
