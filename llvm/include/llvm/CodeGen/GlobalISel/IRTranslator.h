...
private:
  ...
  bool translateInitXGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateInitZGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateXGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateYGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateZGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateHGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateIGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateTGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateTdagGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateSGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateSdagGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateSxGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translatePGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateUGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateRxGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateRyGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateRzGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateCX0Gate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateCX1Gate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateCtrlGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateMeasXGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateMeasYGate(const User &U, MachineIRBuilder &MIRBuilder);
  bool translateMeasZGate(const User &U, MachineIRBuilder &MIRBuilder);

  bool translateSwapGate(const User &U, MachineIRBuilder &MIRBuilder);
