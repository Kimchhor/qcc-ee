...
public:
  enum ArchType {
    ...
    // QCL QCC - backend : add new architecture
    qisa,           // QISA: Quantum Assembly
    // QCL QASM - backend : add new architecture
    qasm,
  ...
  enum OSType {
    ...
    QuantumOS,  // QCL QCC - backend : add new OS type
    Emscripten,
  ...
  // QCL QCC - backend : TODO - set object format
...
public:
  ...
  // QCL QCC - backend - test whether the target is QISA
  /// Tests whether the target is QISA
  bool isQISA() const {
    return getArch() == Triple::qisa;
  }
