...
#ifndef LLVM_TRANDSFORMS_EMITNATIVESINGLE_H
#define LLVM_TRANDSFORMS_EMITNATIVESINGLE_H

#include "llvm/IR/PassManager.h"
#include <map>

namespace llvm {
    class EmitNativeSinglePass : public PassInfoMixin<EmitNativeSinglePass> {
    public:

        /// 다음 선언들이 필요한지 모르겠어.
        // 단일큐비트게이트 분해 정보 테이블 변수 정의 (이름, (분해정보)) | 전역변수로 선언
        ...
        // void analysisSingleIntoList(Instruction &I);
    };
}

#endif // LLVM_TRANDSFORMS_EMITNATIVESINGLE_H