...
#ifndef QCC_QCCSABREROUTING
#define QCC_QCCSABREROUTING
...
///////////////////////////////////////////////////////////////////////
// QCCSABRERouting Class Declaration
///////////////////////////////////////////////////////////////////////

class QCCSABRERouting : public QCCRouting {
...
private:
   ...
   *
   */
  std::vector<int> performSABRE(int starter, int ender);
...
public:
   ...
   *
   */
  QCCSABRERouting(QCCLayout *layout, QODGAnalysis &qodg,
                QCCMachineDescription &machineDescription,
