...
enum {
  ...
  // QCL QCC - backend : add new machine architectures
  EM_QISA = 253,          // QSIA for Quantum processor
  // QCL QASM - backend : add new machine architectures
  EM_QASM = 254,
};
...
// QCL QCC - backend : relocation definitions
// QISA Specific e_flags
enum : unsigned {
  EF_QISA_NABI = 0x80000000,   // Not ABI compliant
  EF_QISA_QISA = 0x00000004,  
  EF_QISA_ISA_V = 0x00090001   // QISA V0.9.1 ISA
  // specific
  // features  
};

// QCL QASM - backend : relocation definitions
// QASM Specific e_flags
enum : unsigned {
  EF_QASM_NABI = 0x80000000,   // Not ABI compliant
  EF_QASM_QASM = 0x00000004,  
  EF_QASM_ISA_V = 0x00090001   // QASM V0.9.1 ISA
  // specific
  // features  
};

// ELF Relocation types for QISA
enum {
  #include "ELFRelocs/QISA.def"
};

// ELF Relocation types for QASM
enum {
  #include "ELFRelocs/QASM.def"
};
