...
public:
  ...
  bool isQubitTy() const { return getTypeID() == QubitTyID; }
  ...
  bool isSingleValueType() const {
    return isFloatingPointTy() || isX86_MMXTy() || isIntegerTy() || isQubitTy() ||
  ...
  bool isSized(SmallPtrSetImpl<Type*> *Visited = nullptr) const {
    ...
    if (getTypeID() == IntegerTyID || isFloatingPointTy() ||
        ...
        getTypeID() == X86_AMXTyID || getTypeID() == QubitTyID  )// QIR HPCL: Qubit Type
      return true;
  ...
  static Type *getQubitTy(LLVMContext &C); // QIR HPCL: Qubit Type
  ...
  static PointerType *getQubitPtrTy(LLVMContext &C, unsigned AS = 0); // QIR HPCL: Instruction
