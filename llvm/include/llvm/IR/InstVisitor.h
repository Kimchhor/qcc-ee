...
#include "llvm/IR/Instruction.def"
  ...
  // Handle Gate instructions
  RetTy visitInitXGateInst(InitXGateInst &I)     { DELEGATE(Instruction); }
  RetTy visitInitZGateInst(InitZGateInst &I)    { DELEGATE(Instruction); }
  RetTy visitXGateInst(XGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitYGateInst(YGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitZGateInst(ZGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitHGateInst(HGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitUGateInst(UGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitIGateInst(IGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitTGateInst(TGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitTdagGateInst(TdagGateInst &I)      { DELEGATE(Instruction); }
  RetTy visitSGateInst(SGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitSdagGateInst(SdagGateInst &I)      { DELEGATE(Instruction); }
  RetTy visitSxGateInst(SxGateInst &I)          { DELEGATE(Instruction); }
  RetTy visitPGateInst(PGateInst &I)            { DELEGATE(Instruction); }
  RetTy visitRxGateInst(RxGateInst &I)          { DELEGATE(Instruction); }
  RetTy visitRyGateInst(RyGateInst &I)          { DELEGATE(Instruction); }
  RetTy visitRzGateInst(RzGateInst &I)          { DELEGATE(Instruction); }
  RetTy visitCX0GateInst(CX0GateInst &I)        { DELEGATE(Instruction); }
  RetTy visitCX1GateInst(CX1GateInst &I)        { DELEGATE(Instruction); }
  RetTy visitCtrlGateInst(CtrlGateInst &I)      { DELEGATE(Instruction); }
  RetTy visitMeasXGateInst(MeasXGateInst &I)    { DELEGATE(Instruction); }
  RetTy visitMeasYGateInst(MeasYGateInst &I)    { DELEGATE(Instruction); }
  RetTy visitMeasZGateInst(MeasZGateInst &I)    { DELEGATE(Instruction); }
  RetTy visitSwapGateInst(SwapGateInst &I)      { DELEGATE(Instruction); }
