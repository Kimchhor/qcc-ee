...
void ModuleBitcodeWriter::writeTypeTable() {
  ...
  for (unsigned i = 0, e = TypeList.size(); i != e; ++i) {
    ...
    // case Type::QubitTyID:     Code = bitc::TYPE_CODE_QUBIT;     break; // QIR HPCL: Qubit Type
    case Type::QubitTyID: {
      Code = bitc::TYPE_CODE_QUBIT;
      QubitType *QT = cast<QubitType>(T);
      TypeVals.push_back(VE.getTypeID(QT));
      errs() << "BitCodeWriter: It working here\n"; 
      break;
    }
...
void ModuleBitcodeWriter::writeInstruction(const Instruction &I,
  ...
  case Instruction::CtrlGate:
    Code = bitc::FUNC_CODE_INST_CTRLGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::InitXGate: // QIR HPCL: Instruction
    Code = bitc::FUNC_CODE_INST_INITXGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::InitZGate: 
    Code = bitc::FUNC_CODE_INST_INITZGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::XGate: 
    Code = bitc::FUNC_CODE_INST_XGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::YGate:
    Code = bitc::FUNC_CODE_INST_YGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::ZGate:
    Code = bitc::FUNC_CODE_INST_ZGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::UGate:
    Code = bitc::FUNC_CODE_INST_UGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::HGate:
    Code = bitc::FUNC_CODE_INST_HGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::IGate:
    Code = bitc::FUNC_CODE_INST_IGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::TGate:
    Code = bitc::FUNC_CODE_INST_TGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::TdagGate:
    Code = bitc::FUNC_CODE_INST_TDAGGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::SGate:
    Code = bitc::FUNC_CODE_INST_SGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::SdagGate:
    Code = bitc::FUNC_CODE_INST_SDAGGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::SxGate:
    Code = bitc::FUNC_CODE_INST_SGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::PGate:
    Code = bitc::FUNC_CODE_INST_PGATE;
    pushValue(I.getOperand(0),InstID, Vals);
    break;
  case Instruction::MeasXGate:
    Code = bitc::FUNC_CODE_INST_MEASXGATE;
    pushValueAndType(I.getOperand(0), InstID, Vals);
    break;
  case Instruction::MeasYGate:
    Code = bitc::FUNC_CODE_INST_MEASYGATE;
    pushValueAndType(I.getOperand(0), InstID, Vals);
    break;
  case Instruction::MeasZGate:
    Code = bitc::FUNC_CODE_INST_MEASZGATE;
    pushValueAndType(I.getOperand(0), InstID, Vals);
    break;

  case Instruction::SwapGate:
    Code = bitc::FUNC_CODE_INST_SWAPGATE;
    pushValueAndType(I.getOperand(0), InstID, Vals);
    pushValueAndType(I.getOperand(1), InstID, Vals);    
    break;
