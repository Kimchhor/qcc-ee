...
Error BitcodeReader::parseTypeTableBody() {
  ...
  while (true) {
    ...
    case bitc::TYPE_CODE_ARRAY:     // ARRAY: [numelts, eltty]
      ...
      break;
    case bitc::TYPE_CODE_QUBIT: // QIR HPCL: Qubit Type
      // TODO: add something below
      // if (Record.empty())
      //   return error("Invalid record");
      ResultTy = Type::getQubitTy(Context);
      break; 
...
Error BitcodeReader::parseFunctionBody(Function *F) {
  ...
  while (true) {
    ...
    // QIR HPCL: Instruction : parse function body
    case bitc::FUNC_CODE_INST_INITXGATE: { 
      unsigned OpNum = 0;
      Value *Qubit;

      if (getValueTypePair(Record, OpNum, NextValueNo, Qubit, &FullTy))
        return error("Invalid record");
      
      I = InitXGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }
        case bitc::FUNC_CODE_INST_INITZGATE: { 
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = InitZGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }
    case bitc::FUNC_CODE_INST_XGATE: { 
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = XGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }

    case bitc::FUNC_CODE_INST_YGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = YGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
      }

    case bitc::FUNC_CODE_INST_ZGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = ZGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }

    case bitc::FUNC_CODE_INST_HGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = HGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }

    case bitc::FUNC_CODE_INST_IGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = IGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }

    case bitc::FUNC_CODE_INST_TGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = TGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }

    case bitc::FUNC_CODE_INST_TDAGGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = TdagGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }
    case bitc::FUNC_CODE_INST_SGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = SGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }
    case bitc::FUNC_CODE_INST_SDAGGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = SdagGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }
   
    case bitc::FUNC_CODE_INST_PGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      Value *Rotate;
      ...
      if (getValueTypePair(Record, OpNum, NextValueNo, Rotate)){
        return error("Invalid Rotate value");
      }              
      I = PGateInst::Create(Qubit, Rotate);
      InstructionList.push_back(I); 
      break;
    }
    
    case bitc::FUNC_CODE_INST_CTRLGATE:{
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = CtrlGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }

    case bitc::FUNC_CODE_INST_MEASXGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = MeasXGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }

    case bitc::FUNC_CODE_INST_MEASYGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = MeasYGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }
    case bitc::FUNC_CODE_INST_MEASZGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      ...
      I = MeasZGateInst::Create(Qubit);
      InstructionList.push_back(I); 
      break;
    }
    case bitc::FUNC_CODE_INST_SWAPGATE: {
      unsigned OpNum = 0;
      Value *Qubit;
      Value *QID;
      ...
      if (getValueTypePair(Record, OpNum, NextValueNo, QID)){
        return error("Invalid Qubit ID value");
      }  
      I = SwapGateInst::Create(Qubit, QID);
      InstructionList.push_back(I); 
      break;
    }
