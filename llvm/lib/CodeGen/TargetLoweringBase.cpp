...
#include "llvm/IR/Instruction.def"
  ...
  case XGate:          return ISD::X_GATE;
  case ZGate:          return ISD::Z_GATE;
  case HGate:          return ISD::H_GATE;
  case IGate:          return ISD::I_GATE;
  case TGate:          return ISD::T_GATE;
  case TdagGate:       return ISD::TDAG_GATE;
  case SGate:          return ISD::S_GATE;
  case SdagGate:       return ISD::SDAG_GATE;
  case UGate:          return ISD::U_GATE;
  case SwapGate:       return ISD::SWAP_GATE;
  case MeasXGate:      return ISD::MEAS_X_GATE;
  case MeasYGate:      return ISD::MEAS_Y_GATE;
  case MeasZGate:      return ISD::MEAS_Z_GATE;
  case InitXGate:      return ISD::INIT_X_GATE;
  case InitZGate:      return ISD::INIT_Z_GATE;
  }
