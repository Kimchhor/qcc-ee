...
private:
  ...
  void visitInitXGate(const User &I);
  void visitInitZGate(const User &I);
  void visitXGate(const User &I);
  void visitYGate(const User &I);
  void visitZGate(const User &I);
  void visitHGate(const User &I);
  void visitIGate(const User &I);
  void visitTGate(const User &I);
  void visitTdagGate(const User &I);
  void visitSGate(const User &I);
  void visitSdagGate(const User &I);
  void visitSxGate(const User &I);
  void visitPGate(const User &I);
  void visitUGate(const User &I);
  void visitRxGate(const User &I);
  void visitRyGate(const User &I);
  void visitRzGate(const User &I);
  void visitCX0Gate(const User &I);
  void visitCX1Gate(const User &I);
  void visitCtrlGate(const User &I);
  void visitMeasXGate(const User &I);
  void visitMeasYGate(const User &I);
  void visitMeasZGate(const User &I);
  void visitSwapGate(const User &I);
