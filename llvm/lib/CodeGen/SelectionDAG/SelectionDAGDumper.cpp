...
std::string SDNode::getOperationName(const SelectionDAG *G) const {
  ...
  // QIR HPCL: SelectionDAG #10
  case ISD::INIT_X_GATE:                return "INIT_X";
  case ISD::INIT_Z_GATE:                return "INIT_Z";
  case ISD::X_GATE:                     return "X_GATE";
  case ISD::H_GATE:                     return "H_GATE";
  case ISD::Y_GATE:                     return "Y_GATE";
  case ISD::Z_GATE:                     return "Z_GATE";
  case ISD::I_GATE:                     return "I_GATE";
  case ISD::T_GATE:                     return "T_GATE";
  case ISD::TDAG_GATE:                  return "TDAG_GATE";
  case ISD::S_GATE:                     return "S_GATE";
  case ISD::U_GATE:                     return "U_GATE";
  case ISD::SDAG_GATE:                  return "SDAG_GATE";
  case ISD::RX_GATE:                    return "RX_GATE";
  case ISD::RY_GATE:                    return "RY_GATE";
  case ISD::RZ_GATE:                    return "RZ_GATE";
  case ISD::CX0_GATE:                   return "CX0_GATE";
  case ISD::CX1_GATE:                   return "CX1_GATE";
  case ISD::MEAS_X_GATE:                return "MEAS_X_GATE";
  case ISD::MEAS_Y_GATE:                return "MEAS_Y_GATE";
  case ISD::MEAS_Z_GATE:                return "MEAS_Z_GATE";
  case ISD::SWAP_GATE:                  return "SWAP_GATE";
  case ISD::CTRL_GATE:                  return "CTRL_GATE";
