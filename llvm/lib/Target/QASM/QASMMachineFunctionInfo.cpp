//===-- QASMMachineFunctionInfo.cpp - QASM private data ----*- C++ -*--===//
//
...
void QASMMachineFunctionInfo::getDataSegmentRegsiterSize(MachineFunction &MF) {
    ...
    for (unsigned i = 0; i < numReg; i++){
        ...
        if (inst){
            ...
            // if the register is array type
                ...
                this->RDSRegisterSize++;
                this->dataRegisterType.push_back(RDS);
            }
        }
    }
