...
#define TYPEKEYWORD(STR, LLVMTY)                                               \
  ...
  TYPEKEYWORD("q1",        Type::getQubitTy(Context)); // QIR HPCL: Qubit Type
...
#define INSTKEYWORD(STR, Enum)                                                 \
  ...
  INSTKEYWORD(init_x,   InitXGate);
  INSTKEYWORD(init_z,   InitZGate);
  INSTKEYWORD(x,        XGate);
  INSTKEYWORD(y,        YGate);
  INSTKEYWORD(z,        ZGate);
  INSTKEYWORD(h,        HGate);
  ...
  INSTKEYWORD(t,        TGate);
  INSTKEYWORD(u,        UGate);
  INSTKEYWORD(tdg,      TdagGate);
  INSTKEYWORD(s,        SGate);
  INSTKEYWORD(sdg,      SdagGate);
  INSTKEYWORD(sx,       SxGate);
  INSTKEYWORD(rx,       XGate);
  INSTKEYWORD(ry,       YGate);
  INSTKEYWORD(rz,       ZGate);
  INSTKEYWORD(p,       PGate);
  INSTKEYWORD(measure_x,    MeasXGate);
  INSTKEYWORD(measure_y,    MeasYGate);
  INSTKEYWORD(measure,    MeasZGate);
  INSTKEYWORD(swap,      SwapGate);
  INSTKEYWORD(ctrl,      CtrlGate);
