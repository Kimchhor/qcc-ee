...
#include "llvm/IR/Metadata.def"
    ...
    bool parseQuantumGate(Instruction *&Inst, PerFunctionState &PFS);
    


    // QCC: Deprecated
    template <typename QuantumGate>
    bool parseSingleQubitGate(Instruction *&Inst, PerFunctionState &PFS);
    
    template <typename QuantumGate>
    bool parseMultiQubitGate(Instruction *&Inst, PerFunctionState &PFS);

    bool parseInitXGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseInitZGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseXGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseYGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseZGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseHGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseIGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseUGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseTGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseTdagGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseSGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseSdagGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseSxGate(Instruction *&Inst, PerFunctionState &PFS);

    bool parsePGate(Instruction *&Inst, PerFunctionState &PFS);

    bool parseCtrlGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseMeasXGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseMeasYGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseMeasZGate(Instruction *&Inst, PerFunctionState &PFS);
    bool parseSwapGate(Instruction *&Inst, PerFunctionState &PFS);
    // QCC: Deprecated end
  };
} // End llvm namespace
