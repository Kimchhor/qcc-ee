...
#include "llvm/BinaryFormat/ELFRelocs/RISCV.def"
    ...
    break;
  // QCL QCC - backend : import the ELF file 
  case ELF::EM_QISA:
    switch (Type) {
#include "llvm/BinaryFormat/ELFRelocs/QISA.def"
  default:
    break;
    }
    // QCL QASM - backend : import the ELF file 
  case ELF::EM_QASM:
    switch (Type) {
#include "llvm/BinaryFormat/ELFRelocs/QASM.def"
  default:
    break;
    }
  case ELF::EM_S390:
