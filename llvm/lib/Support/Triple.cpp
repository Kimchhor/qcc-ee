...
StringRef Triple::getArchTypeName(ArchType Kind) {
  ...
  // QCL QCC - backend : getArchTypeName
  case qisa:           return "qisa";
  // QCL QASM - backend
...
StringRef Triple::getOSTypeName(OSType Kind) {
  ...
  case ZOS: return "zos";
  // QCL QCC - lang : get OS type name
  case QuantumOS: return "quantumos";
  }
...
static Triple::ObjectFormatType getDefaultFormat(const Triple &T) {
  ...
  case Triple::ve:
  case Triple::xcore:
  case Triple::qisa: // QCL QCC - backend : TODO : set object format (should support qcc  object format)
    return Triple::ELF;
  case Triple::qasm:
    return Triple::ELF; // QCL QASM - backend
  case Triple::ppc64:
  case Triple::ppc:
    if (T.isOSAIX())
      return Triple::XCOFF;
...
static unsigned getArchPointerBitWidth(llvm::Triple::ArchType Arch) {
  ...
  case llvm::Triple::qisa: // QCL QCC - lang : set architecture pointer bit width
    return 64;
  case llvm::Triple::qasm: // QCL QASM - lang
    return 64;
  }
...
Triple Triple::get32BitArchVariant() const {
  ...
  case Triple::systemz:
  case Triple::ve:
  case Triple::qisa: // QCL QCC - backend : set unknown arch for 32-bit
    T.setArch(UnknownArch);
    break;
  case Triple::qasm: // QCL QASM - backend
    T.setArch(UnknownArch);
    break;
  case Triple::aarch64_32:
  case Triple::amdil:
