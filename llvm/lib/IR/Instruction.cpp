...
const char *Instruction::getOpcodeName(unsigned OpCode) {
  ...
  // HPCL QIR: Instructions
  case InitXGate:      return "init_x";
  case InitZGate:      return "init_z";
  case XGate:          return "x"; 
  case YGate:          return "y"; 
  case ZGate:          return "z"; 
  case HGate:          return "h"; 
  case IGate:          return "i"; 
  case TGate:          return "t"; 
  case TdagGate:       return "tdg"; 
  case SGate:          return "s"; 
  case SdagGate:       return "sdg";
  case SxGate:         return "sx"; 
  case PGate:          return "p";
  case UGate:          return "u"; 
  case MeasXGate:      return "measure_x"; 
  case MeasYGate:      return "measure_y"; 
  case MeasZGate:      return "measure";
  case SwapGate:       return "swap";
  case CtrlGate:       return "ctrl";
